    ...
    <div className="flex min-h-screen items-center justify-center hersemita-auth-bg p-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-6 text-3xl font-bold text-slate-50">Parent Portal</h1>
          <p className="mt-2 text-slate-400">Sign in to view your runner&apos;s progress.</p>
        </div>

        <SignIn
          forceRedirectUrl="/parent/dashboard"
          signUpForceRedirectUrl="/parent/sign-up"
          appearance={{
            elements: {
              rootBox: "mx-auto",
